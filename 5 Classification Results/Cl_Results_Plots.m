function [] = Cl_Results_Plots(uql, s, H)
%CL_RESULTS_PLOTS - Plots results of the classification analysis
% Specifically:
...
bp(1).BaseValue = 0;
xticks(1:20)
xticklabels({'S1','S2','S3','S4','S5','S6','S7','S8','S9','S10','S11','S12','S13','S14','S15','S16','S17','S18','S19','S20'});
